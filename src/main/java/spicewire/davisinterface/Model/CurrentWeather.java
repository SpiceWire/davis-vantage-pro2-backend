...
public class CurrentWeather {
    ...
    public void setUv(Integer newUv) {
        uv = newUv;
    }
    ...
    public void setStartDateOfCurrentStorm(LocalDate newStartDateOfCurrentStorm) {
    ...
    public void setMonthRain(Double newMonthRain) {
